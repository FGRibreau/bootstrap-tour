...
(function($, window) {
  ...
  LocalStorage = (function(_super) {
    ...
    LocalStorage.prototype.setState = function(options, key, value) {
      return window.localStorage.setItem("" + this.ns + key, value);
    };
  ...
  Tour = (function() {
    ...
    Tour.prototype.showStep = function(i) {
      ...
      if (step.onShow != null) {
        step.onShow(this, this._initEvent());
      }
      if (this._options.onShow !== step.onShow) {
        this._options.onShow(this, this._initEvent());
      }
      ...
      if (step.onShown != null) {
        step.onShown(this, this._initEvent());
      }
      if (this._options.onShown !== step.onShown) {
        return this._options.onShown(this, this._initEvent());
      }
    };
    ...
    Tour.prototype._showPopover = function(step, i) {
      ...
      $nav = $(options.template({
        step: step
      })).wrapAll('<div/>').parent();
      if (step.prev === 0 || options.hidePrev) {
