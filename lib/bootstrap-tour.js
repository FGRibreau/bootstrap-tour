  ...
  Tour = (function() {
    ...
    */
    ...
    Tour.prototype.hideStep = function(i, e) {
      ...
      $el.popover("hide");
      if (this._getProp(step, this._options.step, "overlay", step)) {
        this._toggleOverlay($el, false);
      }
      return this.trigger("hidden", e);
    };
    ...
    */
    ...
    Tour.prototype._toggleOverlay = function($el, display) {
      ...
      return $('#bootstrap-tour-overlay').width($(document.body).outerWidth()).height($(document.body).outerHeight()).fadeIn(300);
    };
    ...
    */
    ...
    Tour.prototype._showPopover = function(step, i) {
      ...
      popover.show();
      if (this._getProp(step, options.step, "overlay", step)) {
        this._toggleOverlay($el, true);
      }
