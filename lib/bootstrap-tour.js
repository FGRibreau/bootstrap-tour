...
(function($, window) {
  var Backend, Cookie, LocalStorage, None, Tour, backend, document;
  ...
  Cookie = (function(_super) {
    ...
    Cookie.prototype.setState = function(options, key, value) {
      return $.cookie("" + options.name + "_" + key, value, {
        expires: 36500,
        path: '/'
      });
    };
    ...
    Cookie.prototype.getState = function(options, key) {
      return $.cookie("" + options.name + "_" + key);
    };
  ...
  LocalStorage = (function(_super) {
    ...
    LocalStorage.prototype.setState = function(options, key, value) {
      return window.localStorage.setItem("" + options.name + "_" + key, value);
    };

    LocalStorage.prototype.getState = function(options, key) {
      return window.localStorage.getItem("" + options.name + "_" + key);
    };
  ...
  Tour = (function() {
    ...
    function Tour(options) {
      ...
      this.persistence = new backend[this._options.persistence in backend ? this._options.persistence : "none"]();
      this._steps = [];
      this.setCurrentStep();
